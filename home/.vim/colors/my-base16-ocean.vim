...
hi clear
syntax reset
let g:colors_name = "my-base16-ocean"
...
call <sid>hi("Operator",     s:gui0D, "", s:cterm0D, "", "none")
...
call <sid>hi("vimfilerDirectory",  s:gui0D, "", s:cterm0D, "", "")
call <sid>hi("vimfilerOpendFile",  s:gui0D, "", s:cterm0D, "", "")
call <sid>hi("vimfilerClosedFile",  s:gui0D, "", s:cterm0D, "", "")
